                ...
                {socialLinks.map((link, i) => {
                  ...
                  return (
                    <motion.a
                      ...
                      className="flex h-full min-h-[76px] w-full items-center gap-3 rounded-xl border border-card-border bg-background/30 p-4 transition-colors hover:border-red-500/40 hover:bg-card"
                    >
